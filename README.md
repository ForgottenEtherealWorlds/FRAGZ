...
* As previously stated, FRAGZ token generation will proceed from time of mint until 5 years has passed which is a total of 1826.2125 days (based on time of contract deployment).
