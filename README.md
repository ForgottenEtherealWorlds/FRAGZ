...
Generation of FRAGZ by Genesis and Genesis Prime will stop at 2027-01-30 (1801317960 unix) and cannot be generated by any other token nor any other mechanism. The purpose of a set date for the end of supply generation is to provide a defined max value of tokens in existence in order to establish valuation. 

The total active and max supply of FRAGZ fluctuate over time due to being subject to current and future destruction ("burning") mechanisms. These will function as deflationary mechanisms. We will also continuously develop more deflationary mechanisms over time in order to continuously promote a rise of price, continued interest in trading and increasing the value of the FRAGZ token.
